    ...
    return(
        <div className="h-full w-full flex flex-col items-center justify-center">
            ...
            <form action="" className="border border-gray-400 w-1/4 pt-4 py-5 px-4">
                <label htmlFor="email" className={`text-sm font-semibold mb-1 block font-figtree`}>Email or Username</label>
                ...
                <div className="w-full flex flex-row space-x-2">
                    ...
                    <Link href="/signup" className={`text-center border border-gray-400 w-1/2 py-1.5 text-sm font-figtree font-semibold hover:bg-gray-900 hover:text-gray-50 hover:border-gray-50`}>SignUp</Link>
                </div>
            </form>
        </div>
    )
